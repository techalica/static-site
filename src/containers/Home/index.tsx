      ...
      >
        ...
        <div className="container relative h-screen flex items-center z-20">
          ...
          <div className="absolute text-center bottom-0 mx-auto left-0 right-0">
            ...
            <span className="overflow-hidden w-0.5 h-24 bg-gray-400 block mx-auto before:animate-scrollDown before:w-0.5 before:h-12 before:bg-red-500 before:block"></span>
          </div>
        </div>
      </section>
            ...
            <div className="col-span-12 space-y-3">
              ...
              <div className="flex flex-wrap items-center justify-center">
                ...
                <Skill
                  ...
                  title="Jquery"
                />
                <Skill logo={<React width={75} height={75} />} title="React" />
